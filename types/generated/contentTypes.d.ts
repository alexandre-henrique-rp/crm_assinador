...
export interface ApiSubClienteSubCliente extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::sub-cliente.sub-cliente': ApiSubClienteSubCliente;
